package com.example.shahir.orderyourfood.Service;
...
import com.example.shahir.orderyourfood.OrderStatus;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        intent.putExtra("userPhone",request.getPhone()); /// this will be used later
        PendingIntent conIntent = PendingIntent.getActivity(getBaseContext(),0,intent,PendingIntent.FLAG_UPDATE_CURRENT);
